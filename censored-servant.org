...
#+begin_src json :tangle policies.json
  {
      "policies": {
          ...
          "ExtensionSettings": {
              ...
              "8cfdd449-54b9-45f4-879f-49c53f50d338": {
                  "_comment": "this is ~Restricted Mode: On~ by Kiko and makes youtube safe.",
                  "installation_mode": "force_installed",                 "install_url":"https://addons.mozilla.org/firefox/downloads/file/1680498/restricted_mode_on-0.0.1.xpi"
              }
          }
      }
  }
...
This installation could probably be done in the local user folder, but I haven't figured out where this code would go in that case.
